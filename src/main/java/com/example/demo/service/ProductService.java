...
public class ProductService {
	...
	public Product getProductById(Long id) {
		return productRepository.findById(id).orElseThrow(() -> new RuntimeException("Ürün bulunamadı: " + id));
	}
	...
	// Admin işlemi: yeni ürün ekleme
	public Product createProduct(Product product, Long categoryId) {
		Category category = categoryRepository.findById(categoryId)
				.orElseThrow(() -> new RuntimeException("Kategori bulunamadı: " + categoryId));
		System.out.println(category);
		// Gelen ürünün TÜM alanları zaten dolu (name, image, stock, price, discount,
		// status)
		// sadece category'yi ekliyoruz
